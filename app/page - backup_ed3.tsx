      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <header className="mb-8 rounded-3xl bg-white p-8 shadow-sm">
          ...
          <button
            ...
            className="mt-5 rounded-2xl bg-red-400 px-5 py-3 text-sm font-medium text-white transition hover:bg-red-700"
          >
            Clear All Data
          </button>
        </header>
        ...
        <section className="mt-6 rounded-3xl bg-white p-6 shadow-sm">
          ...
          <p className="mb-4 text-sm text-slate-500">
            All expenses will be converted to TWD for settlement.
          </p>
